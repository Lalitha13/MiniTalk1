...
public class categories2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.categories2);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0){
                    Intent intent = new Intent(categories2.this,Education1.class);
                    startActivity(intent);
                }
                if(position == 1){
                    Intent intent = new Intent(categories2.this,Politics1.class);
                    startActivity(intent);
                }
                if(position == 2){
                    Intent intent = new Intent(categories2.this,Relations1.class);
                    startActivity(intent);
                }
            }
        });
